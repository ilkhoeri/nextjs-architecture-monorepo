...
import { useId } from '@repo/hooks/use-id';
import { cvx, rem, type cvxVariants, ocx } from 'xuxi';
import { useUncontrolled } from '@repo/hooks/use-uncontrolled';
...
const classes = cvx({
  variants: {
    selector: {
      ...
      panel: 'tabs-panel',
      list: 'tabs-list flex flex-wrap [justify-content:var(--tabs-justify,flex-start)] [gap:var(--tabs-list-gap)] [--tab-grow:unset] flex-row data-[orientation=vertical]:flex-col'
    },
