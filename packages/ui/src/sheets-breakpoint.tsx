...
interface UseStoreSheets {
  isOpen: boolean;
  onOpen: () => void;
  onClose: () => void;
}

export function useStoreSheets(): UseStoreSheets {
    ...
    case 'popover':
      return (
        <Popover modal={modal} open={open} onOpenChange={setOpen}>
          ...
          <Popover.Content align="end" className={cn('p-0 h-[356px] w-[var(--radix-popper-anchor-width)] [--p-select-content:0]', classNames?.content)}>
            {content}
          </Popover.Content>
        </Popover>
      );
