...
import { passwordMessage, passwordSchema } from '@/schemas/user';
...
export function AccountDeleteForm({ account, session, currentAccount }: { account: User; currentAccount: User; session: Session | null | undefined }) {
...
function AccountDeleteDialog({ account, session, currentAccount }: { account: User; currentAccount: User; session: Session | null | undefined }) {
