...
import { formatBytesToMB } from '@repo/utils';
import { FolderFilesColorIcon, TrashFillIcon } from '@repo/icons';
...
export interface __AvatarUploadProps {
  ...
  size?: 'avatar' | 'icon';
  children: (event: CldUploadWidgetChildrenProps) => React.JSX.Element;
}
...
export interface AvatarUploadProps extends Omit<__AvatarUploadProps, 'children'> {
