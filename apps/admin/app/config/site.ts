...
export function siteUrl(path: SiteUrl) {
  ...
  switch (path) {
    ...
    case 'logo':
      return `${absoluteUrl}/icons/asset.png`;
...
export function siteConfig() {
  return {
    ...
    description: 'My Store - TypeScript-first schema validation with static type inference',
    archives: [siteUrl('github')],
    keywords: ['store', 'shop', 'app'],
    links: {
      twitter: siteUrl('x'),
...
export const iconsConfig: { icons: Metadata['icons'] } = {
  icons: {
    icon: [
      { url: '/icons/asset.png' },
      {
...
export const openGraph: Metadata['openGraph'] = {
  ...
  images: [
    {
      url: '/assets/images/screenshot-app.webp',
      width: 1200,
      height: 630
    }
  ],
